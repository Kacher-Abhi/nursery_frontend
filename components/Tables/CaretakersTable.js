...
export const CaretakerTable = ({ nursery }) => {
          ...
          <table className="w-full">
            <thead>
              <tr className="text-md font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
                <th className="px-4 py-3">Caretaker Name</th>
                <th className="px-4 py-3">CareTaker Id</th>
                    ...
                    <tr  key = {selectedCaretaker.caretakerId} className="text-gray-700">
                      <td className="px-4 py-3 border">
                        <div className="flex items-center text-sm">
                          <div>
                            <p className="font-semibold text-black">{selectedCaretaker.name}</p>
                            <p className="text-xs text-gray-600">{selectedCaretaker.designation}</p>
                          </div>
                        </div>
                      </td>
